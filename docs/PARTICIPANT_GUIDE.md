...
> Verbatim transcription of `BUP_CSE_FEST_2026_Participant_Guide_&_Evaluation_Rubric_GridWise_LLM.pdf` (11 pages).
> The PDF remains the authoritative artifact; this file exists so the rules are greppable and diffable.
...
>
> *(The sentence ends here in the source PDF — the text overflows its callout box and the remainder is not present in the file.)*
