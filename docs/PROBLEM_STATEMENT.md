...
> Verbatim transcription of `BUP_CSE_FEST_2026_Preliminary_Problem_Statement_GridWise_LLM.pdf` (9 pages).
> The PDF remains the authoritative artifact; this file exists so the spec is greppable and diffable.
...
*(This section of the PDF also contains a flow diagram rendered as an image. It carries no extractable text beyond the sentence and callout above.)*
